				...
				<div class="navbar navbar-inverse navbar-static-top" role="navigation">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							<li<?php if($page=="home") { ?> class="active"<?php } ?>><a href="/MAMP<?php echo $l; ?>"><?php echo tr("START"); ?></a></li>
							<?php $myWebsite='http://localhost:80'; if($myWebsite!='') { echo '<li><a target="_blank"  class="navbar-brand" target="" href="../">' . tr('MY WEB´S') . '</a></li>'; } ?>
							<li<?php if($page=="phpinfo") { ?> class="active"<?php } ?>><a href="index.php?language=<?php echo $language; ?>&amp;page=phpinfo">PHP INFO</a></li>
						...
						<div class="container">
							<table border="0">
								<tr>
									...
									<td>
										<h1><?php echo tr("Hello!"); ?></h1>
										<h2><?php printf(tr("Are You Ready To Develope?"),appName()); ?></h2>
									</td>
									<td width="30%" class="hidden-xs">
										<img src="images/windowsCarouselRight.png" style="width:100%">
									</td>
								</tr>
							</table>
						</div>
